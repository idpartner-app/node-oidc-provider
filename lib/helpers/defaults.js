...
function makeDefaults() {
  const defaults = {
    ...
    features: {
      ...
      /*
       * features.paymentDetailsInfo
       *
       * description: Enables the retrieval of bank accounts information. Its use requires an opaque Access Token with the scope `payment_details`.
       * This is an experimental feature.
       */
       ...
       *
       * description: Enables support for verified claims as defined in https://openid.net/specs/openid-connect-4-identity-assurance-1_0.html. This
